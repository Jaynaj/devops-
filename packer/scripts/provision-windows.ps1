# Windows provisioning script for AWS
Write-Host "Starting Windows custom provisioning for AWS..."
...
Install-Module -Name AWSPowerShell -Repository PSGallery -Force
...
Write-Host "Windows custom provisioning completed successfully!"
